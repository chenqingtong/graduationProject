...
//    @RequiresPermissions("project:task:queryMyTaskList")
    ...
    public AjaxResult startProjectApproveDefId(@PathVariable(value = "taskId") String taskId, @RequestParam(value = "processDefId", required = false) String processDefId, @RequestParam("url") String url, @RequestBody Map<String, Object> variables) {
